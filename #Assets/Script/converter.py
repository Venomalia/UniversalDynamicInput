...
if(args.type != "v2"):
    ...
    original_style = Path(args.file).stem[7:] # Find a better way to do this
    dhc = {}
...
out_file = open(str(Path(args.file).parent) + "/output_" + args.type + ".json", "w") # There's got to be a better way
